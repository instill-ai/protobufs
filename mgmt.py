...
class MgmtClient(Client):
    ...
    def list_organization_memberships(
        ...
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.ListOrganizationMemberships,
    ...
    def update_organization_membership(
        ...
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.UpdateOrganizationMembership,
    ...
    def delete_organization_membership(
        ...
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.DeleteOrganizationMembership,
    ...
    def get_authenticated_subscription(
        ...
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.GetAuthenticatedUserSubscription,
    ...
    def get_organization_subscription(
        ...
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.GetOrganizationSubscription,
    ...
    def get_pipeline_trigger_count(
        ...
        async_enabled: bool = False,
    ) -> mgmt_interface.GetPipelineTriggerCountResponse:
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.GetPipelineTriggerCount,
                request=mgmt_interface.GetPipelineTriggerCountRequest(
                    namespace_id=namespace_id,
                    start=start,
                    stop=stop,
                ),
        ...
        return RequestFactory(
            method=self.hosts[self.instance].client.GetPipelineTriggerCount,
            request=mgmt_interface.GetPipelineTriggerCountRequest(
                namespace_id=namespace_id,
                start=start,
                stop=stop,
    ...
    def list_pipeline_trigger_table_records(
        ...
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.ListPipelineTriggerTableRecords,
    ...
    def list_pipeline_trigger_chart_records(
        ...
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.ListPipelineTriggerChartRecords,
    ...
    def list_credit_consumption_chart_records(
        ...
        if async_enabled:
            return RequestFactory(
                method=self.hosts[self.instance].async_client.ListCreditConsumptionChartRecords,
